...
const ProductSuggestionCard = ({ product, onUpdate, onDelete, isSelected, onSelect }) => {
  const [isExpanded, setIsExpanded] = useState(false);

  return (
    <div className={`border rounded-lg shadow-sm overflow-hidden ${isSelected ? "ring-2 ring-blue-500" : ""}`}>
      {/* Card Header */}
