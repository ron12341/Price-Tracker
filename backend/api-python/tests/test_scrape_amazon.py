...
class TestScrapeAmazon(unittest.TestCase):
    ...
    def test_successful_scrape_with_price_and_image(self, mock_get):
        ...
        mock_response.text = '<html><body><div id="tp_price_block_total_price_ww"><span class="a-offscreen">$10.99</span></div><img id="landingImage" src="image_url"></body></html>'
    ...
    def test_successful_scrape_with_price_but_no_image(self, mock_get):
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.text = '<html><body><div id="tp_price_block_total_price_ww"><span class="a-offscreen">$10.99</span></div></body></html>'
        mock_get.return_value = mock_response
        url = 'https://www.amazon.com/product'
        result = scrape_amazon(url)
