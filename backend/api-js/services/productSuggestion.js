...
class ProductSuggestionService {
  addProductSuggestion = async (suggestedBy, name, query, stores, reason) => {
  ...
  getAllProductSuggestions = async () => {
    try {
  ...
  getUserProductSuggestions = async (userId) => {
    const result = await ProductSuggestion.find({ suggestedBy: userId });
    return result;
  };

  getEditableProductSuggestion = async (id, userId) => {
  ...
  getPendingProductSuggestions = async () => {
    const result = await ProductSuggestion.find({ status: "pending" });
    return result;
  };

  approveProductSuggestion = async (id) => {
  ...
  bulkApproveAndCreate = async (ids) => {
  ...
  updateProductSuggestionAsAdmin = async (id, updates) => {
  ...
  updateProductSuggestionAsOwner = async (id, updates, userId) => {
  ...
  deleteProductSuggestionAsOwner = async (id, userId) => {
    const suggestion = await ProductSuggestion.findOne({ _id: id, suggestedBy: userId });
  ...
  // ADMIN ONLY
  bulkDeleteProductSuggestions = async (ids) => {
